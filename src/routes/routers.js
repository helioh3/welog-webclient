...
const routes = [

  {
    ...
    children: [
      ...
      { path: 'despesas/:id/visualizar', component: ViewExpense, name: 'painel.despesas.visualizar' },
      
      // { path: 'despesas/:id/editar', component: EditExpense, name: 'painel.despesas.editar' }
