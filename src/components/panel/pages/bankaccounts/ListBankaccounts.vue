        ...
        <div class="mt-4">
          <button class=" bg-pink-600 text-pink-100 rounded transition duration-300 hover:bg-pink-500 hover:text-white focus:outline-none">
            <router-link
              ...
              :to="{name: 'painel.contasbancarias.adicionar'}"
            >Nova conta
            </router-link>
          </button>
            ...
            <table class="min-w-full">
              <thead>
                <tr>
                  ...
                  <th class="px-6 py-3 border-b border-gray-400 bg-gray-100 text-center text-xs leading-4 font-semi-bold text-gray-700 uppercase tracking-wider">
                    Situação
                  </th>
                </tr>
              </thead>
              ...
              <tbody class="bg-white">
                <tr
                  ...
                  :key="bankaccount.id"
                  @dblclick.prevent="view(bankaccount.id)"
                >
