	...
	<div class="bg-white border rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2">
		<form action="" @submit.prevent="onSubmit">
			<div class="-mx-3 md:flex mb-6">
				...
				<div class="md:w-2/4 px-3 mb-6 md:mb-0">
					...
					<input type="text" v-model="bankaccount.nome" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3" placeholder="Nome para a conta">
				</div>
				...
				<div class="md:w-1/4 px-3 mb-6 md:mb-0">
					...
					<input v-model="bankaccount.agencia" v-mask="['###', '####-#', '###-##']" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3"  type="text" placeholder="Agencia">
				...
				<div class="md:w-1/3 px-3 mb-6 md:mb-0">
					...
					<input v-model="bankaccount.conta" v-mask="['###-#', '####-#', '#####-#', '######-#']" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3"  type="text" placeholder="Conta">
		...
		<div class="mt-4">
			...
			<button class=" border-red-500 border text-red-500 rounded transition duration-300 hover:bg-red-700 hover:text-white focus:outline-none">
				<router-link class="inline-block  px-5 py-2" :to="{name: 'painel.contasbancarias'}">Cancelar</router-link>
			</button>
		</div>
