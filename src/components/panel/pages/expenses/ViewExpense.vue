  ...
  <div>
    ...
    <div class="mx-auto px-8 py-1">
      <div class="flex justify-between">
        ...
        <div class="mt-3">
          <button
            @click.prevent="pay(expense.id)"
            class="mr-1 px-4 py-2 bg-white border-gray-500 border text-blue-500 rounded transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none"
          >
            <svg class="feather">
          ...
          <button
            @click.prevent="confirmDelete(expense)"
            class="mr-1 px-4 py-2  border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none"
          >
            <svg class="feather">
        ...
        <div class="-mx-3 md:flex mb-12">
          <div class="md:w-full px-3">
            <table class="md:w-full">
              <thead>
                <tr>
                  <th class="px-6 py-3 border-b-2 border-gray-500 text-left leading-4 text-gray-700 tracking-wider">
                    Parcela
                  </th>
                  <th class="px-6 py-3 border-b-2 border-gray-500 text-left text-sm leading-4 text-gray-700 tracking-wider">
                    Vencimento
                  </th>
                  <th class="px-6 py-3 border-b-2 border-gray-500 text-left text-sm leading-4 text-gray-700 tracking-wider">
                    Pagamento
                  ...
                  <th class="px-6 py-3 border-b-2 border-gray-500 text-right text-sm leading-4 text-gray-700 tracking-wider">
                    Valor (R$)
                  </th>
                  <th class="px-6 py-3 border-b-2 border-gray-500 text-right text-sm leading-4 text-gray-700 tracking-wider">
                    Status
              ...
              <tbody class="bg-white">
                ...
                >
                  ...
                  <td class="text-center px-6 py-3 whitespace-no-wrap border-b border-gray-300">
                    <svg
                      class="feather cursor-pointer w-8"
                      @click.prevent="previewPrint(item.comprovante)"
                    >
                      <use xlink:href="@/assets/svg/feather-sprite.svg#printer"></use>
                    </svg>
                  </td>
